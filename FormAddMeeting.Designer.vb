...
Partial Class FormAddMeeting
    ...
    Private Sub InitializeComponent()
        ...
        Panel21 = New Panel()
        DTPNextAvailable = New DateTimePicker()
        Panel22 = New Panel()
        Label9 = New Label()
        Panel14 = New Panel()
        ...
        Panel12 = New Panel()
        DTPBOOKEDDATE = New DateTimePicker()
        Panel13 = New Panel()
        Label6 = New Label()
        Panel2 = New Panel()
        ...
        Panel21.Controls.Add(DTPNextAvailable)
        ...
        ' DTPNextAvailable
        ' 
        DTPNextAvailable.CalendarMonthBackground = Color.White
        DTPNextAvailable.Dock = DockStyle.Fill
        DTPNextAvailable.Font = New Font("Arial", 11F)
        DTPNextAvailable.Format = DateTimePickerFormat.Time
        DTPNextAvailable.Location = New Point(10, 5)
        DTPNextAvailable.Name = "DTPNextAvailable"
        DTPNextAvailable.ShowUpDown = True
        DTPNextAvailable.Size = New Size(299, 24)
        DTPNextAvailable.TabIndex = 1
        ' 
        ' Panel22
        ' 
        ...
        DTPTo.Font = New Font("Arial", 11F)
        DTPTo.Format = DateTimePickerFormat.Time
        DTPTo.Location = New Point(10, 5)
        DTPTo.Name = "DTPTo"
        DTPTo.Size = New Size(299, 24)
        DTPTo.TabIndex = 0
        ' 
        ' Panel19
        ' 
        ...
        DTPFrom.Font = New Font("Arial", 11F)
        DTPFrom.Format = DateTimePickerFormat.Time
        DTPFrom.Location = New Point(10, 5)
        DTPFrom.Name = "DTPFrom"
        DTPFrom.Size = New Size(299, 24)
        DTPFrom.TabIndex = 1
        ' 
        ' Panel16
        ' 
        ...
        Panel12.Controls.Add(DTPBOOKEDDATE)
        ...
        ' DTPBOOKEDDATE
        ' 
        DTPBOOKEDDATE.CalendarMonthBackground = Color.White
        DTPBOOKEDDATE.Dock = DockStyle.Fill
        DTPBOOKEDDATE.Font = New Font("Arial", 11F)
        DTPBOOKEDDATE.Format = DateTimePickerFormat.Short
        DTPBOOKEDDATE.Location = New Point(10, 5)
        DTPBOOKEDDATE.Name = "DTPBOOKEDDATE"
        DTPBOOKEDDATE.Size = New Size(299, 24)
        DTPBOOKEDDATE.TabIndex = 1
        ' 
        ' Panel13
        ' 
        ...
        Panel8.Controls.Add(TxtBookedBy)
        ...
        ' TxtBookedBy
        ' 
        TxtBookedBy.BorderStyle = BorderStyle.None
        TxtBookedBy.Font = New Font("Arial", 11F)
        TxtBookedBy.Location = New Point(13, 7)
        TxtBookedBy.Name = "TxtBookedBy"
        TxtBookedBy.Size = New Size(267, 17)
        TxtBookedBy.TabIndex = 0
        TxtBookedBy.Text = "Enter"
        ' 
        ' Panel9
        ' 
        ...
        TxtRoomID.Font = New Font("Arial", 11F)
        TxtRoomID.Location = New Point(13, 7)
        TxtRoomID.Name = "TxtRoomID"
        TxtRoomID.Size = New Size(267, 17)
        TxtRoomID.TabIndex = 0
        TxtRoomID.Text = "Enter"
        ' 
        ' Panel5
        ' 
        ...
        Panel24.Controls.Add(TxtBookingID)
        ...
        ' TxtBookingID
        ' 
        TxtBookingID.BorderStyle = BorderStyle.None
        TxtBookingID.Font = New Font("Arial", 11F)
        TxtBookingID.Location = New Point(13, 7)
        TxtBookingID.Name = "TxtBookingID"
        TxtBookingID.Size = New Size(267, 17)
        TxtBookingID.TabIndex = 0
        TxtBookingID.Text = "Enter"
        ' 
        ' PnlForLabelBookID
        ' 
        ...
        ' Panel6
        ' 
        Panel6.Controls.Add(BtnAddMeeting)
        ...
        ' BtnAddMeeting
        ' 
        BtnAddMeeting.BackColor = Color.FromArgb(CByte(46), CByte(80), CByte(127))
        BtnAddMeeting.Dock = DockStyle.Fill
        BtnAddMeeting.FlatAppearance.BorderSize = 0
        BtnAddMeeting.FlatStyle = FlatStyle.Flat
        BtnAddMeeting.Font = New Font("Arial", 10F)
        BtnAddMeeting.ForeColor = Color.White
        BtnAddMeeting.Location = New Point(0, 0)
        BtnAddMeeting.Name = "BtnAddMeeting"
        BtnAddMeeting.Size = New Size(95, 38)
        BtnAddMeeting.TabIndex = 0
        BtnAddMeeting.Text = "Add Book"
        BtnAddMeeting.UseVisualStyleBackColor = False
        ' 
        ' PnlForCancel
        ' 
    ...
    Friend WithEvents TxtBookedBy As TextBox
    ...
    Friend WithEvents BtnAddMeeting As Button
    ...
    Friend WithEvents DTPNextAvailable As DateTimePicker
End Class
