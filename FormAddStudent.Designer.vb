...
Partial Class FormAddStudent
    ...
    Private Sub InitializeComponent()
        ...
        TLPAddNewBook.Size = New Size(489, 388)
        ...
        PnlFillAddnewBook.Location = New Point(3, 41)
        PnlFillAddnewBook.Name = "PnlFillAddnewBook"
        PnlFillAddnewBook.Size = New Size(483, 344)
        ...
        TLPAddNewBookFill.RowStyles.Add(New RowStyle(SizeType.Percent, 85.75581F))
        TLPAddNewBookFill.RowStyles.Add(New RowStyle(SizeType.Percent, 14.2441864F))
        TLPAddNewBookFill.Size = New Size(483, 344)
        ...
        TLPAddNewBookColumn.Size = New Size(477, 289)
        ...
        TLPVariablesAddNewBook.RowCount = 5
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 19.9999962F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 20.0000019F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 20.0000019F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 20.0000019F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 19.9999962F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Absolute, 20F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Absolute, 20F))
        TLPVariablesAddNewBook.Size = New Size(477, 289)
        ...
        TableLayoutPanel3.Size = New Size(471, 55)
        ...
        PnlBorderDueDate.Size = New Size(309, 45)
        PnlBorderDueDate.TabIndex = 1
        ' 
        ' Panel15
        ' 
        Panel15.BackColor = Color.White
        Panel15.Controls.Add(ComboStatus)
        ...
        ComboStatus.Items.AddRange(New Object() {"Currently In", "Checked Out"})
        ...
        Panel12.Controls.Add(DTPTimeIn)
        ...
        DTPTimeIn.Size = New Size(299, 24)
        DTPTimeIn.TabIndex = 1
        ' 
        ' Panel13
        ' 
        ...
        Panel8.Controls.Add(DTPDate)
        Panel8.Dock = DockStyle.Fill
        Panel8.ForeColor = Color.Black
        Panel8.Location = New Point(0, 0)
        Panel8.Margin = New Padding(0)
        Panel8.Name = "Panel8"
        Panel8.Padding = New Padding(10, 5, 0, 0)
        ...
        Panel24.Controls.Add(TxtAttendanceID)
        ...
        TxtAttendanceID.Size = New Size(267, 17)
        TxtAttendanceID.TabIndex = 0
        TxtAttendanceID.Text = "Enter"
        ' 
        ' PnlForLabelBookID
        ' 
        ...
        PnlCancelAdd.Location = New Point(3, 298)
        ...
        ' BtnAddAttendance
        ' 
        BtnAddAttendance.BackColor = Color.FromArgb(CByte(46), CByte(80), CByte(127))
        BtnAddAttendance.Dock = DockStyle.Fill
        BtnAddAttendance.FlatAppearance.BorderSize = 0
        BtnAddAttendance.FlatStyle = FlatStyle.Flat
        BtnAddAttendance.Font = New Font("Arial", 10F)
        ...
        PnlTopAddNewBook.Size = New Size(489, 36)
        ...
        Panel20.Location = New Point(3, 39)
