...
Partial Class Books
    ...
    Private Sub InitializeComponent()
        ...
        TBLFill.RowCount = 2
        TBLFill.RowStyles.Add(New RowStyle(SizeType.Percent, 8.420666F))
        TBLFill.RowStyles.Add(New RowStyle(SizeType.Percent, 91.57934F))
        ...
        PnlBelow.Controls.Add(TBLListOfBooks)
        ...
        Panel8.Controls.Add(LblDateTimeBook)
        ...
        ' LblDateTimeBook
        ' 
        LblDateTimeBook.Font = New Font("Arial", 8F)
        LblDateTimeBook.ForeColor = Color.Gray
        LblDateTimeBook.Location = New Point(369, 0)
        LblDateTimeBook.Name = "LblDateTimeBook"
        LblDateTimeBook.Size = New Size(184, 23)
        LblDateTimeBook.TabIndex = 3
        LblDateTimeBook.Text = "time"
        LblDateTimeBook.TextAlign = ContentAlignment.MiddleLeft
        ' 
        ' Label4
        ' 
        ...
        Panel7.Location = New Point(227, 856)
        Panel7.Margin = New Padding(0)
        Panel7.Name = "Panel7"
        Panel7.Size = New Size(1323, 23)
        Panel7.TabIndex = 1
        ' 
        ' LblDateTime
        ' 
        ...
        ' TBLListOfBooks
        ' 
        TBLListOfBooks.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        TBLListOfBooks.AutoSize = True
        ...
        TBLListOfBooks.Size = New Size(931, 436)
        ...
        TBLListOfBooks.ResumeLayout(False)
    ...
    Friend WithEvents TBLListOfBooks As TableLayoutPanel
