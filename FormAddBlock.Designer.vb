...
Partial Class FormAddBlock
    ...
    Private Sub InitializeComponent()
        ...
        Panel15 = New Panel()
        DTPBlockExpiration = New DateTimePicker()
        Panel16 = New Panel()
        Label7 = New Label()
        Panel7 = New Panel()
        ...
        Panel12 = New Panel()
        DTPDateBlocked = New DateTimePicker()
        Panel13 = New Panel()
        Label6 = New Label()
        Panel2 = New Panel()
        ...
        TLPAddNewBook.Controls.Add(Panel20, 0, 1)
        ...
        TLPAddNewBook.Size = New Size(489, 399)
        ...
        PnlFillAddnewBook.Location = New Point(3, 42)
        PnlFillAddnewBook.Name = "PnlFillAddnewBook"
        PnlFillAddnewBook.Size = New Size(483, 354)
        ...
        TLPAddNewBookFill.RowStyles.Add(New RowStyle(SizeType.Percent, 85.59322F))
        TLPAddNewBookFill.RowStyles.Add(New RowStyle(SizeType.Percent, 14.4067793F))
        TLPAddNewBookFill.Size = New Size(483, 354)
        ...
        TLPAddNewBookColumn.Size = New Size(477, 297)
        ...
        TLPVariablesAddNewBook.Controls.Add(Panel17, 0, 5)
        ...
        TLPVariablesAddNewBook.RowCount = 6
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 16.6666622F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 16.6666679F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 16.6666679F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 16.6666679F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 16.6666679F))
        TLPVariablesAddNewBook.RowStyles.Add(New RowStyle(SizeType.Percent, 16.666666F))
        TLPVariablesAddNewBook.Size = New Size(477, 297)
        ...
        Panel17.Location = New Point(3, 248)
        Panel17.Name = "Panel17"
        Panel17.Size = New Size(471, 46)
        Panel17.TabIndex = 6
        ' 
        ' TableLayoutPanel5
        ' 
        ...
        TableLayoutPanel5.Size = New Size(471, 46)
        ...
        PnlBorderStatus.Size = New Size(309, 36)
        ...
        ComboStatus.Items.AddRange(New Object() {"Active", "Expired"})
        ...
        TableLayoutPanel3.Size = New Size(471, 43)
        ...
        PnlBorderDueDate.Size = New Size(309, 33)
        PnlBorderDueDate.TabIndex = 1
        ' 
        ' Panel15
        ' 
        Panel15.BackColor = Color.White
        Panel15.Controls.Add(DTPBlockExpiration)
        ...
        Panel15.Size = New Size(309, 33)
        Panel15.TabIndex = 0
        ' 
        ' DTPBlockExpiration
        ' 
        DTPBlockExpiration.CalendarMonthBackground = Color.White
        DTPBlockExpiration.Dock = DockStyle.Fill
        DTPBlockExpiration.Font = New Font("Arial", 11F)
        DTPBlockExpiration.Format = DateTimePickerFormat.Short
        DTPBlockExpiration.Location = New Point(10, 5)
        DTPBlockExpiration.Name = "DTPBlockExpiration"
        DTPBlockExpiration.Size = New Size(299, 24)
        DTPBlockExpiration.TabIndex = 1
        ' 
        ' Panel16
        ' 
        ...
        TableLayoutPanel2.Size = New Size(471, 43)
        ...
        PnlBorderBorrowedDate.Size = New Size(309, 33)
        PnlBorderBorrowedDate.TabIndex = 1
        ' 
        ' Panel12
        ' 
        Panel12.BackColor = Color.White
        Panel12.Controls.Add(DTPDateBlocked)
        ...
        Panel12.Size = New Size(309, 33)
        Panel12.TabIndex = 0
        ' 
        ' DTPDateBlocked
        ' 
        DTPDateBlocked.CalendarMonthBackground = Color.White
        DTPDateBlocked.Dock = DockStyle.Fill
        DTPDateBlocked.Font = New Font("Arial", 11F)
        DTPDateBlocked.Format = DateTimePickerFormat.Short
        DTPDateBlocked.Location = New Point(10, 5)
        DTPDateBlocked.Name = "DTPDateBlocked"
        DTPDateBlocked.Size = New Size(299, 24)
        DTPDateBlocked.TabIndex = 1
        ' 
        ' Panel13
        ' 
        ...
        TableLayoutPanel1.Size = New Size(471, 43)
        ...
        PnlBorderBookID.Size = New Size(309, 33)
        ...
        Panel8.Size = New Size(309, 33)
        Panel8.TabIndex = 0
        ' 
        ' TxtReason
        ' 
        TxtReason.BorderStyle = BorderStyle.None
        TxtReason.Font = New Font("Arial", 11F)
        TxtReason.Location = New Point(13, 7)
        TxtReason.Name = "TxtReason"
        TxtReason.Size = New Size(267, 17)
        TxtReason.TabIndex = 0
        TxtReason.Text = "Enter"
        ' 
        ' Panel9
        ' 
        ...
        PnlTitle.Location = New Point(3, 52)
        PnlTitle.Name = "PnlTitle"
        PnlTitle.Size = New Size(471, 43)
        PnlTitle.TabIndex = 1
        ' 
        ' TLPTitle
        ' 
        ...
        PnlBorderStudentID.Size = New Size(309, 33)
        ...
        PnlBookID.Size = New Size(471, 43)
        ...
        TLPBookID.Size = New Size(471, 43)
        ...
        PnlBorderBorrowID.Size = New Size(309, 33)
        PnlBorderBorrowID.TabIndex = 2
        ' 
        ' Panel24
        ' 
        Panel24.BackColor = Color.White
        Panel24.Controls.Add(TxtBlockID)
        ...
        TxtBlockID.Size = New Size(267, 17)
        TxtBlockID.TabIndex = 0
        TxtBlockID.Text = "Enter"
        ' 
        ' PnlForLabelBookID
        ' 
        ...
        PnlForLabelBookID.Size = New Size(156, 37)
        ...
        PnlCancelAdd.Location = New Point(3, 306)
        ...
        ' Panel6
        ' 
        Panel6.Controls.Add(BtnAddBlocked)
        ...
        ' BtnAddBlocked
        ' 
        BtnAddBlocked.BackColor = Color.FromArgb(CByte(46), CByte(80), CByte(127))
        BtnAddBlocked.Dock = DockStyle.Fill
        BtnAddBlocked.FlatAppearance.BorderSize = 0
        BtnAddBlocked.FlatStyle = FlatStyle.Flat
        BtnAddBlocked.Font = New Font("Arial", 10F)
        BtnAddBlocked.ForeColor = Color.White
        BtnAddBlocked.Location = New Point(0, 0)
        BtnAddBlocked.Name = "BtnAddBlocked"
        BtnAddBlocked.Size = New Size(95, 39)
        BtnAddBlocked.TabIndex = 0
        BtnAddBlocked.Text = "Add Blocked"
        ...
        PnlTopAddNewBook.Size = New Size(489, 37)
        ...
        Label1.TabIndex = 0
        Label1.Text = "   Add New Blocked Student"
        ...
        Panel20.Location = New Point(3, 40)
    ...
    Friend WithEvents DTPBlockExpiration As DateTimePicker
    ...
    Friend WithEvents DTPDateBlocked As DateTimePicker
    ...
    Friend WithEvents TxtBlockID As TextBox
    ...
    Friend WithEvents BtnAddBlocked As Button
